...
// Icons
import { ArrowRight, Users, Building2, Zap, Shield, DollarSign, ArrowLeftRight, Wallet, Sparkles } from 'lucide-react';
import { DirectboxSend } from 'iconsax-reactjs';

const TRANSFER_OPTIONS = [
    {
        id: 'internal',
        title: 'Cold Asset Transfer',
        subtitle: 'Send to another Cold Asset user',
        description: 'Instant, secure transfers within the Cold Asset network',
        icon: Users,
        gradient: 'from-emerald-500 via-teal-500 to-cyan-500',
        features: [
            { icon: Zap, text: 'Instant transfer', highlight: true },
            { icon: Shield, text: 'Maximum security' },
            { icon: DollarSign, text: 'Zero fees', highlight: true }
        ],
        badge: 'Recommended',
    ...
    },
    {
        ...
        description: 'Transfer to external wallets on blockchain networks',
        icon: Building2,
        gradient: 'from-blue-500 via-indigo-500 to-purple-500',
        features: [
            { icon: ArrowLeftRight, text: 'Any blockchain' },
            { icon: Wallet, text: 'External wallets' },
            { icon: DollarSign, text: 'Network fees apply' }
        ],
        badge: 'Standard',
            ...
            <div className="relative mx-auto mt-10 max-w-6xl">
                ...
                <motion.div initial={{ opacity: 0, y: -30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-10 text-center">
                    <div className="inline-flex justify-center items-center bg-primary/10 mb-6 rounded-3xl size-14 md:size-16 xl:size-18">
                        <DirectboxSend className="size-7 md:size-8 xl:size-9 text-primary" />
                    </div>
                    ...
                    <p className="mx-auto max-w-2xl text-muted-foreground leading-relaxed">
                        Select how you'd like to send your assets securely
                    </p>
                </motion.div>
