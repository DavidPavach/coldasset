...
export function ErrorScreen({ variant = "fullscreen", type = "generic", size = "md", title, message, showActions = true, onRetry, onGoBack, className = "" }: ErrorScreenProps) {
    ...
    if (variant === "fullscreen") {
        return (
            <motion.div variants={containerVariants} initial="hidden" animate="visible" className={`min-h-dvh bg-linear-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4 ${className}`}>
