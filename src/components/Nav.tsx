...
// Icons
import { WalletMinus, Home3, Logout, BitcoinConvert, WalletAdd1, Discover, Setting2, WalletCheck } from "iconsax-reactjs";

const NAVLINKS = [
    { href: "/dashboard", icon: Home3, label: "Dashboard" },
    { href: "/send", icon: WalletMinus, label: "Send" },
    { href: "/receive", icon: WalletAdd1, label: "Receive" },
    { href: "/swap", icon: BitcoinConvert, label: "Swap" },
    { href: "/discover", icon: Discover, label: "Discovery" },
    { href: "/connect-wallet", icon: WalletCheck, label: "Connect Wallet" },
...
export const SideNav = () => {
    ...
    return (
        <main className="hidden lg:block fixed bg-background border-border border-r lg:w-[20rem] h-dvh text-foreground">
            <p className="mt-3.5 px-4 pb-5 xl:pb-4 border-border border-b font-semibold text-xl xl:text-2xl tracking-tight montserrat">COLD <span className="text-primary">ASSET</span></p>
