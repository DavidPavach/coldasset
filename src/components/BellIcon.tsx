            ...
            <AnimatePresence>
                {open && (
                    <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}
                        ...
                        className="top-full -right-24 sm:-right-20 md:-right-16 lg:-right-10 xl:right-0 z-20 absolute bg-white dark:bg-black shadow-lg mt-2 p-4 lg:py-4 border border-border rounded-xl w-80 sm:w-96 md:w-md">
