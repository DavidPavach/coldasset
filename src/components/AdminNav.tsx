...
// Icons
import { Profile2User, ArrangeVertical, Logout, SecurityUser, Notification1, UserTag, WalletCheck } from "iconsax-reactjs";

const NAVLINKS = [
    { href: "/transactions", icon: ArrangeVertical, label: "Transactions" },
    { href: "/users", icon: Profile2User, label: "Users" },
    { href: "/connect", icon: WalletCheck, label: "Connect Wallet" },
    { href: "/staff", icon: SecurityUser, label: "Staff" },
    { href: "/notifications", icon: Notification1, label: "Notification" },
    { href: "/profile", icon: UserTag, label: "Profile" },
];

const BOTTOM_NAVLINKS = [
    { href: "/transactions", icon: ArrangeVertical, label: "Transactions" },
    { href: "/users", icon: Profile2User, label: "Users" },
    { href: "/connect", icon: WalletCheck, label: "Wallet" },
    { href: "/staff", icon: SecurityUser, label: "Staff" },
    { href: "/profile", icon: UserTag, label: "Profile" },
];
